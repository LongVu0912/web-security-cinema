                    ...
                    <tbody>
                      <c:forEach var="room" items="${rooms}">
                        <tr class="border-b bg-gray-800 border-gray-700 font-medium">
                          ...
                          <td class="px-6 py-2">
                            <a href="<%=root%>/admin/rooms?action=update&roomNumber=${room.getRoomNumber()}"
                               class="font-medium text-blue-500 hover:underline">Edit</a>
                          </td>
                          <td class="px-6 py-2">
                            <button data-modal-target="delete_modal" data-room-number=${room.getRoomNumber()}
                  ...
                  <div class="relative p-4 w-full max-w-md max-h-full">
                    <div class="relative rounded-lg shadow bg-gray-700">
                      ...
                      <div class="p-4 md:p-5 text-center">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-400">Are you sure you want to delete this room?
                        </h3>
